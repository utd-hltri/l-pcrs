    ...
    def __init__(self, desc_vocab_size, impr_vocab_size, buckets,
        ...
        if 0 < num_samples < self.impr_vocab_size:
            ...
            if use_coverage:
                ...
                coverage_cell = tf.nn.rnn_cell.GRUCell(num_units)#coverage_seq2seq.SharedGRUCell(num_units * buckets[-1][0], "SharedGRUCell")
                def seq2seq_f(encoder_inputs, decoder_inputs, do_decode):
                    return coverage_seq2seq.embedding_coverage_attention_seq2seq(
                        encoder_inputs, decoder_inputs, cell, coverage_cell,
