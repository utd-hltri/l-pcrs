...
import edu.utdallas.hltri.logging.NDC;

//import edu.utdallas.hltri.logging.MDC;

/**
 * From: https://github.com/medallia/Word2VecJava/blob/master/src/main/java/com/medallia/word2vec/util/ProfilingTimer.java
 *
...
public class ProfilingTimer implements AC {
  ...
  private static String formatElapsed(long nanos) {
    return formatter.print(Period.millis((int) (nanos / 1000000)).normalizedStandard());
  }
  ...
  public void close() {
    ...
    if (root != null && serializationOutput != null) {
      IOUtils.serialize(root, serializationOutput);
    }
  }
