...
// originally from: package com.google.code.externalsorting;
      ...
      try {
        while (line != null) {
          ...
          while ((currentblocksize < blocksize)
            ...
            tmplist.add(line);
            currentblocksize += line.length() * 2 + 40; // java uses 16 bits per character?
//            if (Math.random() < 0.00001) {
//              System.err.println("Block size: " + currentblocksize);
//            }
          }
  ...
  public static void sortFile(File input, File output, Comparator<String> comparator) throws IOException {
    List<File> l = sortInBatch(input, comparator);
    mergeSortedFiles(l, output, comparator);
  }

  public static void sortFile(File input, File output) throws IOException {
